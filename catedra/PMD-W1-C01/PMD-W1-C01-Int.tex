...
\setbeamercolor{background canvas}{bg=}
 ...
 \begin{frame}{Unidades}
  ...
  \begin{outline}
	...
	\2  Control 1: Semana 5, 15/09
        \2  Control 2: Semana 10, 29/10
        \2  Control 3: Semana 14, 26/11
        \2  Control Recuperativo: Semana 15, 02/12

	\uncover<2->{
	\1 Tareas (25\%, potenciales fechas de entrega):
	\2 Tarea 1: Semana 5:  Septiembre (15/09).
	\2 Tarea 2: Semana 13: Noviembre (17/11).
	}
  ...
  \begin{outline}
   ...
   \begin{itemize}
   \1 1. Calificaciones en actividades complementarias 20\%.
  \1  2. Calificaciones en controles de cátedra 80\%.
  \end{itemize}
  ...
  \small
  \begin{outline}      
   \1 Estudiantes que se ausenten a un control tendrán la oportunidad de recuperarlo con el examen. La nota del examen reemplazará la nota más baja de los controles de la asignatura, solo si la nota del examen es superior.
     \1 Un/a estudiante que cometa plagio obtendrá un 1,0 en la evaluación y el caso será informado a Escuela de Ingeniería.
  \end{outline}
  \end{frame}
  ...
  \2 Slides Clases (Martes [A312b] y Jueves [E405] : 10:00 - 11:20)
  \2 Código 
   \1 Ayudante : X Y   (Jueves 16:00 - 17:20, E505)
   
  \uncover<2->{ \1 Ucampus -- \url{https://ucampus.uoh.cl/uoh/2026/2/COM4002/}
